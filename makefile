...
game.out: Game.o Camera.o Map.o main.o CollisionHandler.o Mario.o LittleGoomba.o KoopaTroopa.o BrickBlock.o QuestionBlock.o NormalBlock.o Flag.o Objects.o Pipe.o
	$(CC) Game.o Camera.o Map.o main.o CollisionHandler.o Mario.o LittleGoomba.o KoopaTroopa.o BrickBlock.o QuestionBlock.o NormalBlock.o Flag.o Objects.o Pipe.o rsdl.cpp $(FLAGS) -o game.out

main.o: Game.h main.cpp
	$(CC) -c main.cpp $(FLAGS)

Game.o: Game.cpp Game.h Map.h Objects.h blockSize.h CollisionHandler.h Camera.h
	$(CC) -c Game.cpp $(FLAGS)
...
Mario.o: Mario.h Mario.cpp blockSize.h Gravity.h MarioDefines.h Game.h
